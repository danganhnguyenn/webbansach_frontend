      ...
      <div className="mx-auto w-full max-w-screen-xl">
        ...
        <div className="px-4 py-6 bg-gray-100 dark:bg-gray-700">
          <div className="max-w-lg mx-auto text-center">
            <h2 className="mb-4 text-lg font-semibold text-gray-900 dark:text-white">Get more updates...</h2>
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
              <input
                ...
                className="w-full sm:w-auto px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-600 dark:text-white"
              />
              <button className="w-full sm:w-auto px-6 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500">
                Subscribe
              </button>
            </div>
